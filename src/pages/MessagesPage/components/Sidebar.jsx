  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <ListItem>
            <ListItemButton selected={location.pathname === '/'} component={RouterLink} to="/">
              <HomeRoundedIcon />
              <ListItemContent>
          ...
          <ListItem>
            <ListItemButton selected={location.pathname === '/favorites'} component={RouterLink} to="/favorites">
              <FavoriteIcon />
              <ListItemContent>
          ...
          <ListItem>
            <ListItemButton selected={location.pathname === '/messages'} component={RouterLink} to="/messages">
